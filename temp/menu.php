        ...
        <nav class="fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-[#0e1726]"
            ...
            <div class="perfect-scrollbar h-full overflow-y-auto overflow-x-hidden">
                <div class="relative pb-5 text-center">
                    ...
                    <h4 class="mb-1 dark:text-white">Tema Seçimi</h4>
                   
                </div>
                <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                    <h5 class="mb-1 text-base leading-none dark:text-white">Renk Seçimi</h5>
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="../home" class="main-logo flex shrink-0 items-center">
                            ...
                            <span
                                class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">Me
                                like Panel</span>
                        </a>
                        <a href="javascript:;"
                                ...
                                <li class="nav-item">
                                    <a href="../home" class="group">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Ana
                                                Sayfa</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="../about" class="group">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Hakkımda</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="../contact" class="group">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">İletişim</span>
                                        </div>
                                    </a>
                                </li>
                                <?php
                                    ...
                                    <li class="nav-item">
                                        <a href="../admin" class="group">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Admin
                                                    Panel</span>
                                            </div>
                                        </a>
                                    </li>
                        ...
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="../assets/images/logo.svg"
                                    alt="image" />
                                <span
                                    class="hidden align-middle text-2xl font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">Me
                                    like Panel</span>
                            </a>
                        ...
                        <div x-data="header"
                            ...
                            <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                ...
                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                    ...
                                    <li>
                                        <a href="../changepass" class="dark:hover:text-white" @click="toggle">
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <a href="../temp/logout.php" class="!py-3 text-danger" @click="toggle">
